fn main() {
    ...
    //let _mempool_space_dashboard = std::process::Command::new("cargo")
    //    .args([
    //        "install",
    //        "--force",
    //        "-vv",
    //        "--path",
    //        "src/bin/mempool-space_dashboard",
    //    ])
    //    .output()
    //    .ok();
    //let _lightning_search = std::process::Command::new("cargo")
    //    .args([
    //        "install",
    //        "--force",
    //        "-vv",
    //        "--path",
    //        "src/bin/lightning_search",
    //    ])
    //    .output()
    //    .ok();

    println!("cargo:rustc-env=MEMPOOL_SPACE_INFO={}", git_describe);
